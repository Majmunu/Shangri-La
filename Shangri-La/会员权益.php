...
<body style="height: 1000px">
	...
	<div class="bread-zhuanqu">
		<div class="crubs">
		<span style="color: #ac8642">首页> </span>	
			<span>会员权益</span>
		</div>
	</div>
	<div style="width: 1519px; height: 50px;"></div>
	<div class="section-1">
	...
	<div class="slick-list">
		<div class="slick-list-box">
			<div class="slick-list-box-card">
		        <div class="card-image"><img src="images/钻石会员.png" width="338px" height="169px"></div>
				<div class="card-title"><p>钻石级会员</p></div>
				<div class="card-txt">每一美元合资格消费，即可赚取1积分</div>
				<div class="card-button-1">
					<form>
						<input type="button" value="立即加入" class="card-button">
					</form>
				</div>
			</div>
		</div>
		<div class="slick-list-box">
			<div class="slick-list-box-card">
		         <div class="card-image"><img src="images/黄金会员.png" width="338px" height="169px"></div>
				 <div class="card-title"><p>黄金级会员</p></div>
				<div class="card-txt">额外赚取25%贵宾金环会奖励积分</div>
					<div class="card-button-1">
					<form>
						<input type="button" value="立即加入" class="card-button">
					</form>
		...
		<div class="slick-list-box">
			<div class="slick-list-box-card">
		        <div class="card-image"><img src="images/翡翠会员.jpg" width="338px" height="169px"></div>
				<div class="card-title"><p>翡翠级会员</p></div>
				<div class="card-txt">额外赚取50%贵宾金环会奖励积分</div>
					<div class="card-button-1">
					<form>
						<input type="button" value="立即加入" class="card-button">
					</form>
